...
// Add page transition after animations end
setTimeout(() => {
  document.body.classList.add('animate__animated', 'animate__fadeOut');
  setTimeout(() => {
    window.location.href = 'notebook.html'; // Redirect to the notebook page
  }, 500); // Reduced transition time to 500ms (0.5 seconds)
}, 18000); // Adjusted total time for animations (e.g., 18 seconds)
